...
var Sticky = (function(){
	...
	// for rebuild function
	function ODBO = (function(){
		...
		function updateItem(sql,callback,callbackerror){}
		
		function addItem(sql,callback,callbackerror){}
		
		function deleteItem(sql,callback,callbackerror){}
		
		function dropTable(table,callback,callbackerror){}
		
		function search(sql,callback,callbackerror){}
		...
		return {
			...
			dropTable : dropTable,
			searchItemByLevel : searchItemByLevel, 
			searchItemByStr : searchItemByStr
